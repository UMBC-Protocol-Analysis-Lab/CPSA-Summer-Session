...
\begin{comment}\begin{frame}\frametitle{Types of strands}
...
\begin{frame}\frametitle{CPSA Penetrator Strands}

\input{slide-templates/adversarial-actions}
\bigskip
\pause
These are identical to the capabilities of a \emph{regular} user.
...
\begin{center}
{\Huge CPSA Exploration}
\end{center}
\pause

Now that you've gotten your feet wet with CPSA, take a look at the documentation!

We have an exploration to guide you through the manual.
We encourage you to read ``around'' the areas where the answers are as well, and try out some of the examples in the manual!
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{qr-codes/Survey2.png}
