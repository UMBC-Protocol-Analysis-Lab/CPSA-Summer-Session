...
\]
This set $\{ 1, \dots , p-1\}$ on multiplication is known as \(\Z_p^*\)
\end{definition}
\pause
...
\pause
\begin{center}
{\Huge Make groups for the Final Project}
\end{center}
\pause
The final project is around the corner :).

Form pairs amongst yourselves by Wednesday at 11:59.

If you don't care or can't find a partner, we will randomly pair you before Thursday's lecture.
\end{frame}
