...
Now that you've seen the model, we will break you into groups with a TA assigned to each group to help and do the typing. You will model this protocol using our new knowledge assumptions.
instance.
\end{frame}
