...
\title{Session 4: PAKE-0, Assumptions, and Macros}
...
\begin{frame}\frametitle{In-Class Activity: Model PAKE-0 in Small Groups}
Now that you've seen the model, we will break you into groups with a TA assigned to each group to help and check your work. You will model this protocol using our new knowledge assumptions.
instance.
\end{frame}
...
Due at 6:00pm on Tuesday the 28th
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{qr-codes/Survey4QRCode.png}
