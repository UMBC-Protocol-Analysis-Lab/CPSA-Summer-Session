...
1. Understand and reason about basic cryptographic concepts;
2. Use CPSA to model protcols based on specifications and identify problems;
3. Read and understand protocol specifications;
4. Understand and reason about mathematical proofs derived from CPSA;
